    ...
    <>
      <section className='min-h-screen bg-gradient-to-br from-[#2026d3] to-blue-900 text-white px-6 py-20'>
        <div className='max-w-4xl mx-auto'>
          ...
          <p className='mb-6'>
            <strong>Trademark:</strong> “DSEnergize” is a registered trademark
          ...
          <div className='space-y-6 text-base leading-7'>
            <p>
              ...
              information when you visit <strong>dsenergize.com</strong> or use
            ...
            <p>
              ...
              Please contact us at sales@dsenergize.com, or bde@dsenergize.com
            ...
            <p>
              ...
              <br />
              DSEnergize does not knowingly collect data from individuals under
              13 years of age.
            </p>
