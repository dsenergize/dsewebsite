        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='space-y-6 text-base leading-7'>
            <p>
              ...
              <br />
              By accessing or using <strong>dsenergize.com</strong>, you agree
            ...
            <p>
              ...
              <ul className='list-disc ml-5 mt-2'>
                ...
                <li>
                  Mirror content from dsenergize.com elsewhere without
                  permission
                </li>
              </ul>
            ...
            <p>
              ...
              <br />
              DSEnergize is a platform created and operated in accordance with
